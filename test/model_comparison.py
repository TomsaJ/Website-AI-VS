...
def main():
    ...
    v = ['1min.mp4','5min.mp4','10min.mp4','15min.mp4', '20min.mp4','25min.mp4', '30min.mp4','35min.mp4','40min.mp4', '45min.mp4']
    print("Current Model;Video; Video in Sekunden; Sekunden; Minuten")
    for model in a:
        for video in v:
            
            tmp_time = time.time()
            file_location = "test_video/" + video
            ...
            print (model + ";" + video + ";" + str(video_duration) + ";" + str((current_time - tmp_time)) + ";" + str((current_time - tmp_time)/60))
